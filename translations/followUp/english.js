...
const translations = {
  ...
  extended: {
      ...
      return (
        <>
          ...
          <ol className="helpSteps">
            <li><strong>It is possible that for the virus to incubate in your body without any symptoms, please come back if your symptoms changed.</strong></li>
            <li>Do not leave your home unless you really need it, because you could get infected.</li>
            <li>Please wait until the authorities have removed the lockdowns and travel bans.</li>
          </ol>
        </>
      )
    },
    Low () {
      return (
        <>
          <h3 className="subtitle">There is a low chance for you to have COVID-19</h3>
          <ol className="helpSteps">
    ...
    Moderate () {
      return (
        <>
          <h3 className="subtitle">There is a moderate chance for you to have COVID-19</h3>
          <ol className="helpSteps">
